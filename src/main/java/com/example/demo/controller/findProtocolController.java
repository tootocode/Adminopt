...
public class findProtocolController {
    ...
    public String postdata(String name,String target,String desc,String date,String excuteexploit,String excutetlstest,String allportscan){
